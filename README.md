...
- **Track a Flight** — type a flight number (IATA or ICAO) to pin it: a progress bar with live position, scheduled/actual times, a delay badge, and telemetry. The currently tracked flight also appears as a small badge in the header next to the clock. While nothing is pinned, the top half of the page runs a widebody showcase — 747, A380, 777, 787, A330, A340, 767, MD-11 — over a radar-style stage, using aircraft icons by [ADS-B Radar](https://adsb-radar.com) for macOS ([App Store](https://apps.apple.com/app/id1538149835)).
